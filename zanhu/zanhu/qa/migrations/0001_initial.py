# Generated by Django 2.2.8 on 2020-01-17 07:08
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('content', markdownx.models.MarkdownxField(verbose_name='回答的特容')),
                ('is_answer', models.BooleanField(default=False, verbose_name='回答是否呗接受')),
                ('created_at', models.DateTimeField(auto_now_add=True, db_index=True, verbose_name='创建时间')),
                ('updated_at', models.DateTimeField(auto_now=True, verbose_name='更新时间')),
                ('question', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='qa.Question', verbose_name='')),
                ('user', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='a_author', to=settings.AUTH_USER_MODEL, verbose_name='问题回答者')),
            ],
            options={
                'verbose_name': '回答',
